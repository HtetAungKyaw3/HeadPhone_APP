...
public class DSP0LogConfigureView extends LinearLayout {
    ...
    public DSP0LogConfigureView(Context context) {
        super(context);

        mCtx = (MainActivity)context;
        LayoutInflater.from(context).inflate(R.layout.fragment_dsp0log_configure, this);

        initUIMember();
    }

    private void initUIMember() {
        dsp0LinearLayout = (LinearLayout) findViewById(R.id.parent_dsp0_layout);
    ...
    public void initLogModuleMember(LoggerList<Byte> info) {
        ...
        while(info.size() > 0) {
            ...
            if(cpuid == CPU_DSP0) {
                ...
                dsp0LinearLayout.addView(myView, dsp0LinearLayout.getChildCount());
            }
        }
    ...
    public void notifyConnected() {
        for (int i = 0; i < dsp0LinearLayout.getChildCount(); i++) {
            OnlinelogConfigItemView child = (OnlinelogConfigItemView)dsp0LinearLayout.getChildAt(i);
    ...
    public void clearLayout() {
        dsp0LinearLayout.removeAllViews();
    }
